...
class AbRecyclerAdapter(private var context: Context, private var abItemLists: List<AbItemList>, private var ft: FragmentTransaction, private val isAktivitas : Boolean) :
